...
; hileras a revisar
hilera1 db "notardesysedraton",0
hilera2 db "hasoidoalaodiosahadamariajose",0
hilera3 db "a",0
hilera4 db "ab",0
hilera5 db "aa",0
hilera6 db "aba",0
...
mov r8, 0 				; contador startStringLoop
mov r9, 0				; contador ciclo getStringLength
...
palindromeLoop:
	...
	jne notPalindrome   				; sálgase del ciclo, funciona como un return
